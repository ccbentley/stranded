...
func to_text() -> String:
	...
	for parameter in params.keys():
		if (
			(typeof(get(params[parameter].property)) != typeof(custom_defaults.get(params[parameter].property, params[parameter].default)))
			or (get(params[parameter].property) != custom_defaults.get(params[parameter].property, params[parameter].default))
		):
