...
func get_shortcode_parameters() -> Dictionary:
	return {
		"action":
		{
			...
			"property": "action",
			"default": Actions.SET_RELATIVE,
			"suggestions":
			func(): return {
				"Set Relative": {"value": 0, "text_alt": ["set_relative", "relative"]},
				"Set Absolute": {"value": 1, "text_alt": ["set_absolute", "absolute"]},
				"Reset": {"value": 2, "text_alt": ["reset"]},
				"Reset All": {"value": 3, "text_alt": ["reset_all"]}
			}
		},
...
func build_event_editor():
	...
	add_header_edit("position", ValueType.NUMBER, {"left_text": "position", "mode": 1}, "action != Actions.RESET_ALL")
	add_header_label("to (absolute)", "action == Actions.SET_ABSOLUTE")
	add_header_label("by (relative)", "action == Actions.SET_RELATIVE")
	add_header_edit("vector", ValueType.VECTOR2, {}, "action != Actions.RESET and action != Actions.RESET_ALL")
