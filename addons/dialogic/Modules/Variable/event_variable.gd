...
func build_event_editor():
	...
	add_header_edit(
		...
		ValueType.FIXED_OPTIONS,
		{
			"options":
			[
				{"label": "to be", "icon": load("res://addons/dialogic/Editor/Images/Dropdown/set.svg"), "value": Operations.SET},
				{"label": "to itself plus", "icon": load("res://addons/dialogic/Editor/Images/Dropdown/plus.svg"), "value": Operations.ADD},
				{"label": "to itself minus", "icon": load("res://addons/dialogic/Editor/Images/Dropdown/minus.svg"), "value": Operations.SUBSTRACT},
				{"label": "to itself multiplied by", "icon": load("res://addons/dialogic/Editor/Images/Dropdown/multiply.svg"), "value": Operations.MULTIPLY},
				{"label": "to itself divided by", "icon": load("res://addons/dialogic/Editor/Images/Dropdown/divide.svg"), "value": Operations.DIVIDE}
			]
		},
		"!name.is_empty()"
	)
	add_header_edit(
		...
		ValueType.FIXED_OPTIONS,
		{
			"options":
			[
				{"label": "String", "icon": ["String", "EditorIcons"], "value": VarValueType.STRING},
				{"label": "Number", "icon": ["float", "EditorIcons"], "value": VarValueType.NUMBER},
				{"label": "Variable", "icon": load("res://addons/dialogic/Editor/Images/Pieces/variable.svg"), "value": VarValueType.VARIABLE},
				{"label": "Bool", "icon": ["bool", "EditorIcons"], "value": VarValueType.BOOL},
				{"label": "Expression", "icon": ["Variant", "EditorIcons"], "value": VarValueType.EXPRESSION},
				{"label": "Random Number", "icon": ["RandomNumberGenerator", "EditorIcons"], "value": VarValueType.RANDOM_NUMBER}
			],
			"symbol_only": true
		},
		"!name.is_empty()"
