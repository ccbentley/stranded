...
func build_event_editor():
	add_header_edit(
		...
		ValueType.FIXED_OPTIONS,
		{
			"options":
			[
				{"label": "Set", "value": Modes.SET, "icon": load("res://addons/dialogic/Editor/Images/Dropdown/default.svg")},
				{"label": "Reset", "value": Modes.RESET, "icon": load("res://addons/dialogic/Editor/Images/Dropdown/update.svg")},
				{"label": "Reset All", "value": Modes.RESET_ALL, "icon": load("res://addons/dialogic/Editor/Images/Dropdown/update.svg")},
			]
		}
	)
	...
	add_header_edit(
		...
		ValueType.FIXED_OPTIONS,
		{
			...
			"options":
			[
				{"label": "String", "icon": ["String", "EditorIcons"], "value": SettingValueType.STRING},
				{"label": "Number", "icon": ["float", "EditorIcons"], "value": SettingValueType.NUMBER},
				{"label": "Variable", "icon": ["ClassList", "EditorIcons"], "value": SettingValueType.VARIABLE},
				{"label": "Expression", "icon": ["Variant", "EditorIcons"], "value": SettingValueType.EXPRESSION}
			],
			"symbol_only": true
		},
...
func _get_code_completion(CodeCompletionHelper: Node, TextNode: TextEdit, line: String, word: String, symbol: String) -> void:
	...
	if (symbol == " " or symbol == '"') and !"=" in line and CodeCompletionHelper.get_line_untill_caret(line).count('"') != 2:
		for i in get_settings_suggestions(""):
			...
			if symbol == '"':
				TextNode.add_code_completion_option(
					CodeEdit.KIND_MEMBER, i, i, event_color.lerp(TextNode.syntax_highlighter.normal_color, 0.5), TextNode.get_theme_icon("GDScript", "EditorIcons"), '"'
				)
			else:
				TextNode.add_code_completion_option(
					CodeEdit.KIND_MEMBER, i, '"' + i, event_color.lerp(TextNode.syntax_highlighter.normal_color, 0.5), TextNode.get_theme_icon("GDScript", "EditorIcons"), '"'
