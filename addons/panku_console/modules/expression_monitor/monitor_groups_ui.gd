...
func add_group() -> MonitorGroup:
	...
	group_ui.group_move_up.connect(func(): groups_container.move_child(group_ui, group_ui.get_index() - 1))
	group_ui.group_move_down.connect(func(): groups_container.move_child(group_ui, group_ui.get_index() + 1))
	return group_ui
