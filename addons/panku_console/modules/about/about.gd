...
func _ready():
	...
	project_page_button.pressed.connect(func(): OS.shell_open("https://github.com/Ark2000/PankuConsole"))

	check_update_button.pressed.connect(func(): _module.core.gd_exprenv.execute("check_latest_release.check()"))
